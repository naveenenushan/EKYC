#
#  Be sure to run `pod spec lint EKYC.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "gfrgrrwgrt"

  spec.homepage     = "http://EXAMPLE/EKYC"
  ...
  spec.license      = "Description of your licence, name or otherwise"
  ...
  spec.author             = { "Naveen Enushan" => "naveenenushan@gmail.com" }
  # Or just: spec.author    = "Naveen Enushan"
  # spec.authors            = { "Naveen Enushan" => "naveenenushan@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Naveen Enushan"
...
#spec.frameworks = 'AAILivenessSDK'
